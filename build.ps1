# Build the cpa-codex-autoban plugin into a Windows .dll.
#
# Requirements:
...
#         plugins/windows/amd64/cpa-codex-autoban.dll
#   (CPA also accepts it directly under plugins/ . The plugin id is the file
#    name without the extension: "cpa-codex-autoban".)

$ErrorActionPreference = "Stop"

$out = "cpa-codex-autoban.dll"
